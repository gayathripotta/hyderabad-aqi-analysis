...
## Method
1. Built a Python script to pull live readings from both APIs and store them in a SQLite database
2. Ran the collection script repeatedly over multiple days to build a real-world dataset
3. Used SQL queries and pandas to calculate average AQI per station and by hour
4. Applied statistical anomaly detection (rolling mean ± 2 standard deviations) to flag unusual spikes
5. Built a Power BI dashboard with a comparison chart, an average AQI KPI card, and a written insight
...
![AQI Trend Chart](aqi_trend_chart.png)
